...
const skillColors: Record<string, { bg: string; border: string; text: string }> = {
  html: { bg: "bg-orange-500/10", border: "border-orange-500/30", text: "text-orange-500" },
  css: { bg: "bg-blue-500/10", border: "border-blue-500/30", text: "text-blue-500" },
  javascript: { bg: "bg-yellow-500/10", border: "border-yellow-500/30", text: "text-yellow-500" },
  git: { bg: "bg-red-500/10", border: "border-red-500/30", text: "text-red-500" },
  responsive: { bg: "bg-teal-500/10", border: "border-teal-500/30", text: "text-teal-500" },
  looker: { bg: "bg-orange-600/10", border: "border-orange-600/30", text: "text-orange-600" },
  python: { bg: "bg-blue-400/10", border: "border-blue-400/30", text: "text-blue-400" },
  sql: { bg: "bg-cyan-500/10", border: "border-cyan-500/30", text: "text-cyan-500" },
  powerbi: { bg: "bg-amber-500/10", border: "border-amber-500/30", text: "text-amber-500" },
}
  ...
  return (
    ...
    >
      <div className="max-w-[1040px] mx-auto px-4">
        ...
        <p className="text-muted-foreground mb-8 text-lg tracking-wide">{t.sections.skillsDesc}</p>
